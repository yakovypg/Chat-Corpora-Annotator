...
namespace SuggesterBenchmark.Benchmarks
{
    public class HistogramAlgorithmBenchmark : BenchmarkBase
    {
        ...
        private const string Q1 = "select haswordofdict(test), haswordofdict(skill), haswordofdict(test) inwin 30"; // 1 100k
        ...
        public HistogramAlgorithmBenchmark()
        {
            ...
            Console.WriteLine($"\n{histograms.Count} were loaded from {ToolInfo.HistogramsPath}\n");
